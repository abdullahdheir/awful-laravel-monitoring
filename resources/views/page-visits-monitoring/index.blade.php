                    ...
                    <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                        <td>
                            <div class="flex items-center pl-5">
                                <a href="{{ $visit->link }}" class="text-base font-medium leading-none text-gray-700 mr-2">
                                    {{ $visit->link }}
                                </a>
                            </div>
                        </td>
                        ...
                        <td class="pl-4">
                            <form method="post" action="{{ route('awful_monitoring.page_visits_monitoring.delete', $visit->id) }}">
                                @csrf
                                @method('DELETE')

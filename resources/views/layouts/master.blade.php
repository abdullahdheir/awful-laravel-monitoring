    ...
    <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
        <div class="sm:flex items-center justify-between">
            <div class="flex items-center">
                @if(Route::has('awful_monitoring.page_visits_monitoring.index'))
                    <a class="rounded-full focus:outline-none focus:ring-2 focus:bg-indigo-50 focus:ring-indigo-800"
                       href="{{ route('awful_monitoring.page_visits_monitoring.index') }}">
                        <div class="py-2 px-8 text-indigo-700 rounded-full hover:text-indigo-700 hover:bg-indigo-100
                                {{ request()->routeIs('awful_monitoring.page_visits_monitoring.index') ? 'bg-indigo-100' : '' }}">
            ...
            <div>
                <a href="https://github.com/abdullahdheir/laravel-awful_monitoring"
